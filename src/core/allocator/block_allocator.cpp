...
BlockAllocator::BlockAllocator(const BlockAllocatorConfig &config, const LlaisysRuntimeAPI *api)
    ...
    _layer_stride = _config.block_size * _config.nkvh * _config.dh * _config.elem_size;
    _block_stride = _config.nlayer * _layer_stride;

    size_t total_bytes = _config.num_blocks * _block_stride;
